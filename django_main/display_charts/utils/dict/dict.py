...
"GOS_avg" : "Средние значение Государтственного экзамена(Россия), или его аналога в других странах",
...
"percent_avg_cnt_st_to_all" : "Процент посещаемости предметов на данном направлении",
    ...
    "avg_salary_new/avg_region_sal": "Отношение средней зарплаты выпускника к средней зарплате по региону",
